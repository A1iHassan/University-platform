  ...
  return (
    <section className="bg-slate-50 py-20 px-6">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="rounded border border-slate-200 bg-white p-10 shadow-md mb-12">
          <div className="mb-6">
          ...
          {services.map((service) => {
            ...
            return (
              <Link
                key={service.title}
                to={service.to}
                className="group overflow-hidden rounded bg-white shadow-md transition-all duration-300 hover:-translate-y-2 hover:shadow-xl"
              >
                {/* Top Section */}
