...
const Pages = () => {
	return <main className="h-svh w-full flex flex-col justify-between">
	  ...
	  <div className="mx-auto mt-40 flex justify-center gap-10 h-[35svh]">
	    ...
	    <Link to={{pathname: "/admission-requirements"}} className="cursor-pointer flex flex-col items-start p-10 w-2/5 h-f shadow-xl/30 bg-[#d67528ff] text-slate-50 hover:bg-slate-50 hover:text-[#d67528ff] transition-color duration-200">
