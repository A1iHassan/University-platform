...
const NavBar = () => {
     ...
     <nav className={`px-3 flex justify-center transition-all duration-500 bg-[#d67528ff]`}>
	  ...
	  <li className='fixed right-0 flex gap-4 mr-3'>
          ...
          <li className={`transition-all duration-500 opacity-100 translate-y-0`}><Link to={{pathname: "/about"}} className="inline-block px-5 py-4 text-sm font-semibold text-slate-50 transition-colors duration-200 hover:text-slate-900 border-b-2 border-transparent hover:border-slate-800">عن الجامعة</Link></li>
          <li className={`transition-all duration-500 opacity-100 translate-y-0`}><Link to={{pathname: "/programs"}} className="inline-block px-5 py-4 text-sm font-semibold text-slate-50 transition-colors duration-200 hover:text-slate-900 border-b-2 border-transparent hover:border-slate-800">القبول و التقديم</Link></li>
